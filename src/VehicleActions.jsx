...
const VehicleActions = ({ vehicle, onClose, onRefresh }) => {
    ...
    const handlePaidRent = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://spcarparkingbackend.vercel.app/reactivateVehicle/${vehicle._id}`, {
                method: 'PUT',
                headers: {
    ...
    const handleDeleteVehicle = async () => {
        setLoading(true);
        try {
            const response = await fetch(`https://spcarparkingbackend.vercel.app/removeVehicle/${vehicle._id}`, {
                method: 'DELETE'
            });
