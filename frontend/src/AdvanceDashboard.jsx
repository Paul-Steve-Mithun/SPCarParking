                            ...
                            <div className="mt-6 flex flex-col sm:flex-row gap-4">
                                <div className="relative w-full sm:w-48">
                                    <select 
                                        ...
                                        className="w-full appearance-none bg-white bg-opacity-20 text-teal-900 px-4 py-3 pr-10 rounded-xl focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 font-medium"
                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-sm sm:text-sm font-medium text-gray-900">
                                                                <div className="w-full text-right font-mono">
                                                                    <span className={`inline-block w-[100px] text-right text-base ${vehicle.advanceRefund ? 'text-red-600' : ''}`}>
                                                                        {vehicle.advanceRefund 
