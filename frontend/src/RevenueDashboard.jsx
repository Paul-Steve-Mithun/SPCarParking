                ...
                <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div className="bg-gradient-to-r from-green-500 to-green-600 p-4 sm:p-6">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                                <h1 className="text-2xl sm:text-4xl font-bold text-white">Revenue Dashboard</h1>
                                <button 
                                    onClick={generatePDF} 
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                        <div className="p-4 sm:p-8">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Transaction History</h2>
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {revenueData.map((record) => (
                                            <tr key={record._id} className="hover:bg-gray-50 transition-colors duration-150">
                                                <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-900 font-medium">{record.vehicleNumber}</td>
                                                <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600">{record.vehicleDescription}</td>
                                                <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600">{record.lotNumber}</td>
                                                <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600">{record.rentalType}</td>
                                                <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600">{record.transactionType}</td>
