...
export function HomePage({ isAuthenticated, onAuthentication }) {
    ...
    const VehicleModal = () => {
        ...
        return (
            <div className="fixed inset-0 flex items-center justify-center z-50">
                ...
                />
                <div className={`rounded-2xl w-full max-w-4xl mx-2 max-h-[90vh] sm:max-h-[80vh] overflow-hidden relative transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-white'
                    }`}>
                    ...
                    {/* Search Bar */}
                    <div className={`p-3 sm:p-4 border-b transition-colors duration-300 ${isDarkMode ? 'border-gray-700' : 'border-gray-200'
                        }`}>
                        <div className="relative">
                            <input
                                ...
                                className={`w-full pl-9 pr-3 py-2 text-sm sm:text-base rounded-lg border transition-all duration-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${isDarkMode
                                    ? 'bg-gray-800 border-gray-600 text-gray-100 placeholder-gray-400'
                                    : 'border-gray-200 text-gray-900 placeholder-gray-500'
                                    }`}
                            />
                            <div className={`absolute left-2.5 top-1/2 -translate-y-1/2 ${isDarkMode ? 'text-gray-400' : 'text-gray-400'
                                }`}>
                    ...
                    <div className="p-3 sm:p-6 overflow-auto max-h-[calc(90vh-120px)] sm:max-h-[calc(80vh-140px)]">
                        {displayedVehicles.length === 0 ? (
                            <div className={`text-center py-8 text-sm sm:text-base transition-colors duration-300 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                                }`}>
                                                ...
                                                <div className="flex flex-col gap-1.5 sm:gap-2">
                                                    <div className="flex items-start justify-between gap-2">
                                                        <div className="min-w-0 flex-1">
                                                            <h3 className={`font-semibold text-sm sm:text-base truncate transition-colors duration-300 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                                                }`}>
                                            ...
                                            <div className="p-3 sm:p-4 space-y-2">
                                                ...
                                                {vehicle.ownerName && (
                                                    <div className="flex items-center justify-between text-xs sm:text-sm">
                                                        ...
                                                        <span className={`font-medium truncate max-w-[60%] transition-colors duration-300 ${isDarkMode ? 'text-gray-200' : 'text-gray-900'
                                                            }`}>
    ...
    const LoginSection = () => {
        ...
        return (
            <div className={`min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'
                }`}>
                {/* Main Content */}
                <div className="max-w-5xl w-full">
                    <motion.div
                        ...
                        className={`rounded-2xl shadow-xl overflow-hidden transition-colors duration-300 ${isDarkMode ? 'bg-gray-800' : 'bg-white'
                            }`}
                    >
                            ...
                            <div className="lg:w-7/12 p-8 lg:p-12">
                                <div className="max-w-md mx-auto">
                                    <div className="text-center mb-8">
                                        <h2 className={`text-2xl font-bold transition-colors duration-300 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                            }`}>Welcome Back!</h2>
                                    ...
                                    <form onSubmit={handleLogin} className="space-y-6">
                                        {loginError && (
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, y: 0 }}
                                                className={`p-4 rounded-xl border flex items-center space-x-3 transition-colors duration-300 ${isDarkMode
                                                    ? 'bg-red-900/20 border-red-800'
                                                    : 'bg-red-50 border-red-100'
                                                    }`}
                                            >
                                                <AlertCircle className="w-5 h-5 text-red-500" />
                                                <p className={`text-sm font-medium transition-colors duration-300 ${isDarkMode ? 'text-red-400' : 'text-red-600'
                                                    }`}>{loginError}</p>
                                            </motion.div>
                                        )}
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className={`w-full pl-12 pr-4 py-3.5 rounded-xl border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${isDarkMode
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className={`w-full pl-12 pr-12 py-3.5 rounded-xl border focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${isDarkMode
                                                            ? 'bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400'
                                                            : 'border-gray-200 text-gray-900 placeholder-gray-500'
                                                            }`}
                                                        required
        ...
        if (isLoading) {
            return (
                <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12">
                    <div className={`rounded-3xl shadow-2xl overflow-hidden border transition-all duration-300 ${isDarkMode
                        ...
                        <div className="p-4 sm:p-6 lg:p-8">
                            {/* Chart Skeleton */}
                            <div className={`rounded-xl sm:rounded-2xl border p-4 sm:p-6 mb-6 sm:mb-8 transition-all duration-300 ${isDarkMode
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                {Array.from({ length: 3 }).map((_, index) => (
                                    <div key={index} className={`p-4 sm:p-6 rounded-xl sm:rounded-2xl border transition-all duration-300 ${isDarkMode
                                        ? 'bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700'
                                        : 'bg-gradient-to-br from-gray-50/50 to-white border-gray-200'
                                        }`}>
        ...
        return (
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12">
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5 }}
                    className={`rounded-3xl shadow-2xl overflow-hidden border transition-all duration-300 ${isDarkMode
                        ? 'bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 border-gray-700 shadow-gray-900/50'
                        : 'bg-gradient-to-br from-white via-gray-50 to-white border-gray-200 shadow-gray-200/50'
                        }`}
                >
                            ...
                            <div className="-mx-1 px-1 overflow-x-auto whitespace-nowrap flex items-center gap-2 pb-1">
                                {['All', 2023, 2024, 2025, 2026].map(y => (
                                    <button
                                        ...
                                        className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-[11px] sm:text-xs font-semibold border transition-colors shrink-0 ${selectedYear === y
                    ...
                    <div className="p-4 sm:p-6 lg:p-8">
                        ...
                        <div className={`rounded-xl sm:rounded-2xl border p-4 sm:p-6 mb-6 sm:mb-8 transition-all duration-300 ${isDarkMode
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-2 sm:space-y-0">
                                <div className="flex-1">
                                    <h3 className={`text-lg sm:text-xl font-bold mb-1 sm:mb-2 transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-gray-900'
                                        }`}>
                                ...
                                <div className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-xs font-medium self-start ${isDarkMode
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            <motion.div
                                ...
                                className={`group p-4 sm:p-6 rounded-xl sm:rounded-2xl border transition-all duration-300 hover:shadow-lg hover:scale-105 ${isDarkMode
                            ...
                            >
                                <div className="flex items-center space-x-3 sm:space-x-4">
                                    <div className={`p-2 sm:p-3 rounded-xl sm:rounded-2xl transition-all duration-300 ${isDarkMode
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className={`text-xs sm:text-sm font-medium mb-1 transition-colors duration-300 ${isDarkMode ? 'text-blue-300' : 'text-blue-600'
                                            }`}>Peak Month</p>
                                        <p className={`text-lg sm:text-2xl font-bold transition-colors duration-300 truncate ${isDarkMode ? 'text-white' : 'text-gray-900'
                                            }`}>
                                            {chartData.length > 0
                            ...
                            >
                                <div className="flex items-center space-x-3 sm:space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className={`text-xs sm:text-sm font-medium mb-1 transition-colors duration-300 ${isDarkMode ? 'text-indigo-300' : 'text-indigo-600'
                                            }`}>Total Registrations</p>
                                        <p className={`text-lg sm:text-2xl font-bold transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-gray-900'
                                            }`}>
                                            {filteredCounts.new}
                                        </p>
                                    </div>
                            ...
                            >
                                <div className="flex items-center space-x-3 sm:space-x-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className={`text-xs sm:text-sm font-medium mb-1 transition-colors duration-300 ${isDarkMode ? 'text-emerald-300' : 'text-emerald-600'
                                            }`}>Total Exits</p>
                                        <p className={`text-lg sm:text-2xl font-bold transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-gray-900'
                                            }`}>
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'
            ...
            {!isAuthenticated ? (
                ...
                <>
                    {/* Hero Section */}
                    <div className={`relative overflow-hidden shadow-sm transition-colors duration-300 ${isDarkMode ? 'bg-gray-800' : 'bg-white'
                        }`}>
                        {/* Background Pattern */}
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                >
                                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold">
                                        <motion.span
                                            className={`inline-block font-mono font-black tracking-tight ${isDarkMode ? 'text-blue-400' : 'text-blue-600'
                                                }`}
                                            initial={{ opacity: 0, y: 20 }}
                                            animate={{ opacity: 1, y: 0 }}
                                            transition={{
                                    ...
                                    <motion.p
                                        className={`mt-4 text-xl max-w-2xl mx-auto transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'
                                            }`}
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                            ...
                            {isLoading
                                ...
                                : stats.map((stat, index) => (
                                    <motion.div
                                        ...
                                        className={`group relative rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 ${isDarkMode ? 'bg-gray-800' : 'bg-white'
                                            }`}
                                    >
                                        <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${isDarkMode ? 'bg-gradient-to-r from-gray-700 to-gray-800' : 'bg-gradient-to-r from-gray-50 to-white'
                                            }`} />
                                        <div className="relative p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <ChevronRight className={`w-5 h-5 transition-colors duration-300 ${isDarkMode ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-400 group-hover:text-gray-600'
                                                    }`} />
                                            </div>
                                            <h3 className={`text-lg font-semibold mb-1 transition-colors duration-300 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                                }`}>
                                                {stat.label}
                                            </h3>
                                            <div className="flex items-center justify-between">
                                                <p className={`text-3xl font-bold transition-colors duration-300 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
                                                    }`}>
                                                    {stat.value}
                                                </p>
